...
/* ---- SPLIT FEATURED VS LATEST (no more duplicates) ----
   Items marked Featured = Yes in the sheet show in the Featured
   section (max 6). Everything else shows in Latest. If nothing is
   marked Featured, the first 6 fill that section as a fallback. */
